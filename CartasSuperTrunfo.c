...
float area1, pib1, densidade1, pib_percapita1 = 0, superpoder1;
...
float area2, pib2, densidade2, pib_percapita2 = 0, superpoder2;

//Calculo dos resultados
int resultadoArea, resultadoPib, resultadoPontos,
resultadoPopulacao, resultadoSuperpoder, resultadoPibPercapita, resultadoDensidade;
...
//Calcúlo do desafio (Densidade populacional, PIB per capita e Super Poder)

densidade1 = (float)populacao1 / area1;
pib_percapita1 = (pib1 * 1000000000.0f) / (float)populacao1;
superpoder1 = (float)populacao1 + area1 + pib1 + (float)pontos_tur1 + (1.0f / densidade1) + pib_percapita1;

//Esqueleto printf da carta1
...
superpoder2 = (float)populacao2 + area2 + pib2 + (float)pontos_tur2 + (1.0f / densidade2) + pib_percapita2;

//Esqueleto printf da carta2
...
resultadoPontos = pontos_tur1 > pontos_tur2;
resultadoDensidade = densidade1 < densidade2;
resultadoPibPercapita = pib_percapita1 > pib_percapita2;
